 ...
 * 
 * VERSION 6.0.0 - TRINITY HEALING LOOP
 * 
...
const EXPECTED_VERSION = '6.0.0-trinity-healer';
...
async function main() {
  ...
  try {
    ...
    // Verify version
    if (base.VERSION && !base.VERSION.includes('trinity-healer') && !base.VERSION.includes('6.0')) {
