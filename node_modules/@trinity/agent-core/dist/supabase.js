...
exports.isMockMode = exports.supabaseAdmin = exports.supabase = void 0;
...
// ------------------------------------------------------------------
async function logMockCall(method, args) {
...
if (!supabaseUrl || !supabaseKey) {
    ...
    const createUniversalMock = (resolvedData = []) => {
        return new Proxy({}, {
            get: (target, prop) => {
                ...
                if (prop === 'unsubscribe')
                    return () => { };
                if (prop === 'url')
                    return 'http://mock-supabase.local';
                if (prop === 'headers')
                    return {};
    ...
    client = {
        from: (table) => createUniversalMock([]),
...
exports.supabaseAdmin = serviceKey
    ? (0, supabase_js_1.createClient)(supabaseUrl, serviceKey, {
        auth: {
...
exports.isMockMode = !supabaseUrl || !supabaseKey;
