...
exports.GoogleWorkspaceMCP = void 0;
const BaseMCP_1 = require("./BaseMCP");
const googleapis_1 = require("googleapis");
class GoogleWorkspaceMCP extends BaseMCP_1.BaseMCP {
    constructor() {
    ...
    async listEvents(args) {
        ...
        const calendar = googleapis_1.google.calendar({ version: 'v3', auth: this.auth });
    ...
    async listEmails(args) {
        if (!this.auth)
            throw new Error('Not authenticated');
        const gmail = googleapis_1.google.gmail({ version: 'v1', auth: this.auth });
...
exports.GoogleWorkspaceMCP = GoogleWorkspaceMCP;
